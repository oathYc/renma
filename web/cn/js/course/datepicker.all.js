...
$(function () {
    ...
    var PICKERFOOTERTPL = '<div class="c-datepicker-picker__footer" style="">' +
        '<button type="button" class="c-datepicker-button c-datepicker-picker__link-btn c-datepicker-button--text c-datepicker-button--mini c-datepicker-picker__btn-now cancle">' +
        '<span>' +
        '取消' +
        '</span>' +
        '</button>' +
    ...
    var PICKERTIMEHEADERTPL = '<span class="{{className}}__editor-wrap">' +
        ...
        '<input type="text" autocomplete="off" placeholder="" class="c-datepicker-input__inner c-datePicker__input-time">' +
        '</div>' +
        '</span>';
    //  范围
    ...
    $.extend(Day.prototype, {
        ...
        eventSingle: function () {
            ...
            function setValue(activeNum, input, inputDay) {
                ...
                this.picker.$input.attr('value',inputVal);
                result_data=inputVal;
            }
        },
        eventRange: function () {
            // 点击选择日期
    ...
    $.extend(RangeDatePicker.prototype, {
        ...
        event: function () {
            ...
            // 点击取消
            this.$container.on('click', '.c-datepicker-picker__link-btn.cancle', function () {
                var _this = API.getPicker($(this));
                _this.datePickerObject.hide();
            });
            // 点击清空
