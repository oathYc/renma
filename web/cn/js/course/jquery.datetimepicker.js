            ...
            createDateTimePicker = function (input) {
                var datetimepicker = $('<div ' + (options.id ? 'id="' + options.id + '"' : '') + ' ' + (options.style ? 'style="' + options.style + '"' : '') + ' class="xdsoft_datetimepicker xdsoft_noselect ' + options.className + '"></div>'),
                    ...
                    mounth_picker = $('<div class="xdsoft_mounthpicker">' +
                        '<button type="button" class="xdsoft_prev"><i class="kxiconfont icon-left c-datepicker-picker__icon-btn c-datepicker-date-picker__prev-btn month"></i></button>' +
                        '<div class="xdsoft_label xdsoft_year"><span></span></div>' +
                        '<div class="xdsoft_label xdsoft_month"><span></span></div>' +
                        '<button type="button" class="xdsoft_next"><i class="kxiconfont icon-right c-datepicker-picker__icon-btn c-datepicker-date-picker__next-btn month"></i></button></div>'),
