...
CREATE TABLE `cy_catalog`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 36 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '目录结构表' ROW_FORMAT = Dynamic;
...
INSERT INTO `cy_catalog` VALUES (35, '用户购物车', 4, 1572869476, 'user-shop-cat', 0, 1);
...
CREATE TABLE `cy_category`  (
  ...
  `createTime` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 53 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '问题类型分类  两级' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `cy_coupon` VALUES (1, 'fefed', 9000.00, 0.00, 1000, 1572836975, '');
...
CREATE TABLE `cy_group_product`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '组团商品' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `cy_member` VALUES (1, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 0, NULL, 'ddDCSDF5', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `cy_member_log`  (
  ...
  `createTime` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '成员开通会员记录' ROW_FORMAT = Fixed;
...
CREATE TABLE `cy_order`  (
  ...
  `status` int(1) NULL DEFAULT NULL COMMENT '订单状态 1-支付成功 0-支付失败',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cy_order_logistics`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单物流' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cy_product`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cy_role_catalog`  (
  ...
  `createTime` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 63 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色权限表' ROW_FORMAT = Fixed;
...
CREATE TABLE `cy_shop_cart`  (
  ...
  `createTime` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户购物车' ROW_FORMAT = Fixed;
...
CREATE TABLE `cy_shop_message`  (
  ...
  `type` tinyint(1) NULL DEFAULT 0 COMMENT '1-关于我们',
  `createTime` int(11) NULL DEFAULT NULL COMMENT '时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商城信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cy_user_address`  (
  ...
  `phone` char(12) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '电话',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户收货地址' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cy_user_coupon`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户使用优惠卷' ROW_FORMAT = Fixed;
...
CREATE TABLE `cy_user_push`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '内容提交 反馈' ROW_FORMAT = Dynamic;
