    ...
    <ul class="nav">
        <li class="dropdown pull-right">
            <a class="dropdown-toggle"
               href="/content/product/good-product-add">添加商品</a>
        </li>
    </ul>
    <form action="/content/product/good-product" method="get" class="form-horizontal">
        <table class="table">
            <tr>
            </tr>
        </table>
    </form>
    <form action="/content/product/good-product" method="post">
...
<!--                            <a class="btn" href="/content/content/good-product-add?id=--><?php //echo $v['id']; ?><!--">修改</a>-->
                            <a class="btn" href="JavaScript:if(confirm('确认移除该优选商品？')){location.href='/content/product/good-product-delete?id=<?php echo $v['id']; ?>'}">删除</a>
                        </div>
                    </td>
                </tr>
                <?php
