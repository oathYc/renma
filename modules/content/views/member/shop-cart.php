...
<div class="span10" id="datacontent">
    <ul class="breadcrumb">
        ...
        <li class="active">用户购物车</li>
    </ul>
    <ul class="nav">
    </ul>
    <form action="/content/member/user-shop-cart" method="get" class="form-horizontal">
        <table class="table">
            <tr>
            </tr>
        </table>
    </form>
    <form action="/content/member/user-shop-cart" method="get">
        <table class="table table-hover add_defined">
            ...
            foreach( $data as $kss => $v) {
                ...
                <tr>
                    ...
                    <td ><span><?php echo $v['nickname']?$v['nickname']:$v['name']?></span></td>
