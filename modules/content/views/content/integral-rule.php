...
<div class="span10" id="datacontent">
    ...
    <form action="/content/content/integral-rule" method="post" class="form-horizontal" onsubmit="javascript:if(confirm('确定提交该内容？')){return true}else{
        return false;
    }">
        <fieldset>
            <div class="control-group">
                <label for="modulename" class="control-label">积分规则</label>
                <div class="controls">
