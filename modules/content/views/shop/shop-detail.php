    ...
    <form action="/content/shop/shop-detail" method="get" class="form-horizontal" >
        <fieldset>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="shopTime" id="shopTime" value="<?php echo isset($data['shopTime'])?$data['shopTime']:'';?>"  />
                </div>
            </div>
            <div class="control-group">
                <label for="modulename" class="control-label">店铺状态</label>
                <div class="controls">
                    <input type="text" name="status" id="status" value="<?php echo isset($data['status'])?($data['status']==1?'审核通过':($data['status']==-1?'审核不通过':'待审核')):'';?>"  />
                </div>
            </div>
            <div class="control-group">
                <label for="modulename" class="control-label">店铺地址</label>
                <div class="controls">
                    <input type="text" name="address" id="address" value="<?php echo isset($data['address'])?($data['province'].$data['city'].$data['area'].$data['address']):'';?>" />
                </div>
            </div>
            <div class="control-group">
                <label for="modulename" class="control-label">店铺封面</label>
                <div class="controls">
                    <input type="text" name="headImage" id="headImage" value="<?php echo isset($data['headImage'])?$data['headImage']:'';?>" />
                </div>
            </div>
...
<!--            --><?php //}?>
            <?php if(isset($data['video']) && $data['video']){?>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <textarea name="video" ><?php echo isset($data['video'])?$data['video']:'';?></textarea>
                    </div>
                </div>
            <?php }?>
            <div class="control-group">
                ...
                <div class="controls">
                    <textarea name="introduce" ><?php echo isset($data['introduce'])?$data['introduce']:'';?></textarea>
                </div>
            </div>
            <br/>
            <div class="control-group">
